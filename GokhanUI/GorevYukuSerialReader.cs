...
namespace GokhanUI
{
    public class GorevYukuSerialReader : IDisposable
    {
        ...
        public GorevYukuSerialReader(string portName, int baudRate)
        {
        ...
        public void Open()
        {
            try
            {
                if (!_serialPort.IsOpen)
                {
                    ...
                    Console.WriteLine("Gorev yuku baglantisi acildi.");
                }
            }
            catch (Exception ex)
            {
        ...
        public void Close()
        {
            ...
            {
                _serialPort.Close();
                Console.WriteLine("Gorev yuku baglantisi kapatildi.");
            }
        }
        ...
        private void ParseData(byte[] buffer)
        {
            ...
            ushort hamvoltage = BitConverter.ToUInt16(buffer, i); i += 2;
            Voltage = (ushort)(hamvoltage / 100);
